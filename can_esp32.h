...
bool class_can_open()
{
  can_general_config_t g_config = CAN_GENERAL_CONFIG_DEFAULT(GPIO_NUM_17, GPIO_NUM_16, CAN_MODE_NORMAL);
...
bool class_can_send_msg(struct CAN_DATA *pCan)
{
...
bool class_can_read_msg(struct CAN_DATA *pCan)
{
  can_message_t message;
